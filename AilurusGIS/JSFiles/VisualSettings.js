/**
 * Функция для применения всех визуальных настроек к глобусу Cesium
 * @param {Cesium.Viewer} viewer - инстанс Cesium Viewer
 */
function applyVisualSettings(viewer) {
    ...
    // 6. FXAA для сглаживания краёв (анти-алиасинг)
