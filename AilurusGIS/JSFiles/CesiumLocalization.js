...
function localizeCesiumUI(viewer) {
    ...
    const globalDictionary = [
        ...
        { ru: 'Границы Казахстана (GeoJSON)', en: 'Kazakhstan Borders (GeoJSON)', kz: 'Қазақстан шекарасы (GeoJSON)' },
        { ru: 'Границы Казахстана GeoJSON (Вкл)', en: 'Kazakhstan Borders GeoJSON (On)', kz: 'Қазақстан шекарасы GeoJSON (Қосулы)' },
        { ru: 'Границы Казахстана GeoJSON (Выкл)', en: 'Kazakhstan Borders GeoJSON (Off)', kz: 'Қазақстан шекарасы GeoJSON (Өшірулі)' },
    ...
    const partialDictionary = [
        ...
        { ru: 'Загрузка GeoJSON границ Казахстана...', en: 'Loading Kazakhstan GeoJSON borders...', kz: 'Қазақстан GeoJSON шекарасын жүктеу...' },
