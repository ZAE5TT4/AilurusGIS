...
function localizeCesiumUI(viewer) {
    ...
    const globalDictionary = [
        ...
        { ru: 'Улучшенные границы стран (SHP)', en: 'Improved Country Borders (SHP)', kz: 'Жақсартылған ел шекаралары (SHP)' },
        { ru: 'Улучшенные границы стран SHP (Вкл)', en: 'Improved Country Borders SHP (On)', kz: 'Жақсартылған ел шекаралары SHP (Қосулы)' },
        { ru: 'Улучшенные границы стран SHP (Выкл)', en: 'Improved Country Borders SHP (Off)', kz: 'Жақсартылған ел шекаралары SHP (Өшірулі)' },
    ...
    const partialDictionary = [
        ...
        { ru: 'Загрузка улучшенных SHP границ стран...', en: 'Loading improved country SHP borders...', kz: 'Жақсартылған ел шекаралары SHP жүктелуде...' },
