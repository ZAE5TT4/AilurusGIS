/**
 * Умный скрипт мультиязычности и локализации (ГЛУБОКАЯ БЕЗОТКАЗНАЯ ВЕРСИЯ).
 * Работает двунаправленно, напрямую внедряется в Knockout ViewModels Cesium.
 * Полностью переписано для поддержки динамических Property и MutationObserver.
...
function localizeCesiumUI(viewer) {
    ...
    const partialDictionary = [
        ...
        { ru: 'Загрузка SHP Границ...', en: 'Loading SHP Borders...', kz: 'SHP шекараларын жүктеу...' },
